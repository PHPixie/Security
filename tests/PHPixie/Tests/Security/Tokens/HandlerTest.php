...
namespace PHPixie\Tests\Security\Tokens;

/**
 * @coversDefaultClass \PHPixie\Security\Tokens\Handler
 */
class HandlerTest extends \PHPixie\Test\Testcase
{
    ...
    public function setUp()
    {
        ...
        $this->random = $this->quickMock('\PHPixie\Security\Random');
        ...
        $this->storage = $this->quickMock('\PHPixie\Security\Tokens\Storage');
        ...
        $this->handler = new \PHPixie\Security\Tokens\Handler(
            $this->tokens,
            $this->random,
            $this->configData
        );
    ...
    public function testCreate()
    {
        ...
        $this->assertSame($token, $this->handler->create(5, 100));
    }
