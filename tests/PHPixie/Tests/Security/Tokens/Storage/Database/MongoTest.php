...
/**
 * @coversDefaultClass \PHPixie\Security\Tokens\Storage\Database\Mongo
 */
class MongoTest extends \PHPixie\Tests\Security\Tokens\Storage\DatabaseTest
{
    ...
    {
        return new \PHPixie\Security\Tokens\Storage\Database\Mongo(
            $this->tokens,
            $this->connection,
            $this->configData
        );
