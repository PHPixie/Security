...
namespace PHPixie\Tests\Security\Tokens\Storage;

/**
 * @coversDefaultClass \PHPixie\Security\Tokens\Storage\Database
 */
abstract class DatabaseTest extends \PHPixie\Test\Testcase
{
    ...
    /**
     * @covers \PHPixie\Security\Tokens\Storage\Database::__construct
     * @covers ::__construct
     * @covers ::<protected>
     */
